...
def add_multihuman_pos_markers(multi_human_pos_ATMD: np.ndarray,
    ...
    # marker_history_pos_ATD = multi_human_pos_ATMD[:,:present_idx,:]
    # marker_history_mask_AT = multi_human_mask_AT[:,:present_idx]

    # marker_current_pos_AD = multi_human_pos_ATMD[:,present_idx,:]
    ...
    # marker_future_pos_ATD = multi_human_pos_ATMD[:,present_idx+1:,:]
    ...
    current_color = ColorRGBA(r=1.0, g=0.5, b=0.5, a=1.0)
    future_color = ColorRGBA(r=0.5, g=0.5, b=0.0, a=0.7)
